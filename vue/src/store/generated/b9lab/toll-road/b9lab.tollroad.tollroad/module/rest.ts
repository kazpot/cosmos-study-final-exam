...
export interface TollroadMsgCreateRoadOperatorResponse {
  index?: string;
}
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/b9lab/toll-road/tollroad/params
   */
   ...
   *
   * @tags Query
   * @name QueryRoadOperatorAll
   * @summary Queries a list of RoadOperator items.
   * @request GET:/b9lab/toll-road/tollroad/road_operator
   */
  queryRoadOperatorAll = (
    query?: {
    ...
    this.request<TollroadQueryAllRoadOperatorResponse, RpcStatus>({
      path: `/b9lab/toll-road/tollroad/road_operator`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   *
   * @tags Query
   * @name QueryRoadOperator
   * @summary Queries a RoadOperator by index.
   * @request GET:/b9lab/toll-road/tollroad/road_operator/{index}
   */
  queryRoadOperator = (index: string, params: RequestParams = {}) =>
    this.request<TollroadQueryGetRoadOperatorResponse, RpcStatus>({
      path: `/b9lab/toll-road/tollroad/road_operator/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
